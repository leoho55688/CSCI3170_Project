...
2. SystemAdministrator.java - tasks related to the system, e.g. creating and deleting tables, inserting data into the database and showing content.
3. Salesperson.java - tasks related to transactions, e.g. searching for parts and handling transactions
